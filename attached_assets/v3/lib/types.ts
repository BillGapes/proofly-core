...
export interface User { id: string; handle: string; name: string; kycStatus?: 'unverified'|'pending'|'verified'; }
...
export interface Education { id: string; userId: string; org: string; degree: string; start: string; end?: string; notes?: string; }
